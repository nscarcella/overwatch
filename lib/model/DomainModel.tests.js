...
describe('DomainModel', () => {
	...
	const domainClass = DomainModel('DC', schema)
	...
	it('may receive the class definition', () => {
		const domainClass = DomainModel('DC', schema, { get meh() { return 9 } } )
		const instance = new domainClass()
	...
	describe('classes', () => {
		...
		it('should override default properties with overlapping class definition', () => {
			const domainClass = DomainModel('DC', schema, { get bar() { return 9 } } )
			const instance = new domainClass()
